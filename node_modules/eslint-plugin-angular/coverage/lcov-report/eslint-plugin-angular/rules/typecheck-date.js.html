...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">eslint-plugin-angular/rules/</a> typecheck-date.js
    </h1>
    <div class='clearfix'>
...
module.exports = function(context) {
    function recordError(node, origin) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (node.type === 'Literal' &amp;&amp; node.value === '[object Date]') {
