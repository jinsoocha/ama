...
<html lang="en">
<head>
    <title>Code coverage report for eslint-plugin-angular/rules/utils/angular-rule.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">eslint-plugin-angular/rules/utils/</a> angular-rule.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">1508×</span>
...
&nbsp;
    ...
    function checkCallee(ruleObject, context, callExpressionNode) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (callee.type === 'MemberExpression') {
...
&nbsp;
    ...
    function findProviderGet(providerFn) {
        ...
        providerFn.body.body.some(function(statement) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (expression.left.type === 'MemberExpression' &amp;&amp; expression.left.property.name === '$get') {
