...
<html lang="en">
<head>
    <title>Code coverage report for eslint-plugin-angular/rules/utils/utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">eslint-plugin-angular/rules/utils/</a> utils.js
    </h1>
    <div class='clearfix'>
...
537
538
539</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (isIdentifierType(controllerArg)) {
        return findIdentiferInScope(context, controllerArg);
    }
}
&nbsp;
