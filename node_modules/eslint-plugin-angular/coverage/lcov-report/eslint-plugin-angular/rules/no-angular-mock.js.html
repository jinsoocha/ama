...
<html lang="en">
<head>
    <title>Code coverage report for eslint-plugin-angular/rules/no-angular-mock.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">eslint-plugin-angular/rules/</a> no-angular-mock.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        MemberExpression: function(node) {
            if (node.object.type === 'Identifier' &amp;&amp; node.object.name === 'angular' &amp;&amp;
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (node.parent.type === 'MemberExpression' &amp;&amp; node.parent.property.type === 'Identifier') {
