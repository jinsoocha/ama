...
<html lang="en">
<head>
    <title>Code coverage report for eslint-plugin-angular/rules/no-services.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">eslint-plugin-angular/rules/</a> no-services.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        for (prop in map) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (map.hasOwnProperty(prop)) {
                result.push(prop);
            }
        }
&nbsp;
