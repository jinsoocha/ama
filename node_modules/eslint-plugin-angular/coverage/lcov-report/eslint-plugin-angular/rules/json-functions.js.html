...
<html lang="en">
<head>
    <title>Code coverage report for eslint-plugin-angular/rules/json-functions.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">eslint-plugin-angular/rules/</a> json-functions.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        MemberExpression: function(node) {
            if (node.object.name === 'JSON') {
                ...
                } else <span class="missing-if-branch" title="else path not taken" >E</span>if (node.property.name === 'parse') {
