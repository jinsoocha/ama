...
<html lang="en">
<head>
    <title>Code coverage report for eslint-plugin-angular/rules/one-dependency-per-line.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">eslint-plugin-angular/rules/</a> one-dependency-per-line.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    function findFunctionDeclarationByVariableDeclaration(body, fName) {
        ...
        body.forEach(function(item) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (item.type === 'VariableDeclaration') {
                item.declarations.forEach(function(declaration) {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (declaration.type === 'VariableDeclarator' &amp;&amp;
                        declaration.id &amp;&amp;
...
&nbsp;
    function getFunctionDeclaration(node, fName) {
        if (node.type === 'BlockStatement' || node.type === 'Program') {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (node.body) {
