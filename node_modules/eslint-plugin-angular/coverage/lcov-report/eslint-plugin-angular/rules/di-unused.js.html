...
<html lang="en">
<head>
    <title>Code coverage report for eslint-plugin-angular/rules/di-unused.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">eslint-plugin-angular/rules/</a> di-unused.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    function collectAngularScopes(scope) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (visitedScopes.indexOf(scope) === -1) {
