...
<html lang="en">
<head>
    <title>Code coverage report for eslint-plugin-angular/rules/module-setter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">eslint-plugin-angular/rules/</a> module-setter.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        VariableDeclaration: function(node) {
            ...
            var rightExpression;
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (variableDeclarator.init) {
                rightExpression = variableDeclarator.init;
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (rightExpression.arguments &amp;&amp; utils.isAngularModuleDeclaration(rightExpression)) {
