...
<html lang="en">
<head>
    <title>Code coverage report for eslint-plugin-angular/rules/definedundefined.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">eslint-plugin-angular/rules/</a> definedundefined.js
    </h1>
    <div class='clearfix'>
    ...
    return {
        MemberExpression: function(node) {
            if (node.object.name === 'angular' &amp;&amp;
                ...
                } else <span class="missing-if-branch" title="else path not taken" >E</span>if (node.property.name === 'isUndefined') {
